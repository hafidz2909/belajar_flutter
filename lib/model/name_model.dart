...
class NameModel {
  ...
  @override
  String toString() => 'NameModel(nameSchool: $nameSchool, address: $address, principal: $principal)';
  ...
  @override
  int get hashCode => nameSchool.hashCode ^ address.hashCode ^ principal.hashCode;
}
